...
export interface Settings { name: string; strict: boolean; unit: 'kg' | 'lb'; startDate: string; increasePercent: number; decreasePercent: number; restSeconds: number; theme?: 'light' | 'dark' | 'automatic'; checkInDay?: number }
