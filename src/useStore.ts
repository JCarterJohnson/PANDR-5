...
export function useStore() {
 ...
 useEffect(()=>{const online=()=>{if(profileRef.current!=='local')void sync()};window.addEventListener('online',online);return ()=>window.removeEventListener('online',online)},[sync]);
